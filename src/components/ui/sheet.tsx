    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          variant === "default" && side === "right" && "border-l",
          variant === "default" && side === "left" && "border-r",
          variant === "default" && side === "top" && "border-b",
          variant === "default" && side === "bottom" && "border-t",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            className={cn(
              "absolute opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none",
              variant === "admin"
                ? "top-5 right-5 flex size-9 items-center justify-center rounded-full border border-border/70 bg-background shadow-sm hover:bg-muted"
                : "top-4 right-4 rounded-lg data-[state=open]:bg-secondary"
            )}
          >
